...
- OpenCode serve binds to `0.0.0.0` (was `127.0.0.1`) in the runner harness, fixing all nightly task failures under gVisor where Docker port-mapped traffic was rejected on the loopback interface.
