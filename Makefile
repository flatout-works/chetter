...
MCP_IMAGE ?= ghcr.io/devfleet/devfleet-mcp:local
RUNNER_BASE_IMAGE ?= ghcr.io/devfleet/devfleet-runner-base:local
RUNNER_IMAGE ?= ghcr.io/devfleet/devfleet-runner:local
build:
	mkdir -p bin
