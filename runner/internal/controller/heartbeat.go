...
func (r *Runner) runnerHeartbeatSnapshot(status string) runnerHeartbeat {
	...
	return runnerHeartbeat{
		...
		RunnerID:       r.runnerID,
		Status:         status,
		ImageRef:       firstEnv("DEVFLEET_RUNNER_IMAGE", "DEVFLEET_RUNNER_IMAGE", "CONTAINER_IMAGE"),
		ImageDigest:    firstEnv("DEVFLEET_RUNNER_IMAGE_DIGEST", "DEVFLEET_RUNNER_IMAGE_DIGEST"),
		Version:        firstEnv("DEVFLEET_RUNNER_VERSION", "VERSION", "GITHUB_SHA"),
