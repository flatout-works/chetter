...
SELECT id, name, okta_group_id, okta_group_name, created_at, updated_at, max_concurrent_tasks FROM teams WHERE id = $1
`
...
SELECT id, name, okta_group_id, okta_group_name, created_at, updated_at, max_concurrent_tasks FROM teams WHERE name = $1
`
...
SELECT id, name, okta_group_id, okta_group_name, created_at, updated_at, max_concurrent_tasks FROM teams ORDER BY name ASC
`
