...
func buildReviewTaskRequest(review ReviewContext) SubmitTaskRequest {
	...
	env := map[string]string{
		...
		"DEVFLEET_AGENT_NAME":   "pr-reviewer",
		"DEVFLEET_MODEL_ID":     "opencode-go/minimax-m3",
	}
...
- DEVFLEET_AGENT_NAME — agent definition name (e.g., "pr-reviewer")
- DEVFLEET_MODEL_ID — model identifier (e.g., "opencode-go/minimax-m3")
- DEVFLEET_RUNNER_IMAGE — runner container image (e.g., "ghcr.io/.../devfleet-runner:main")
- DEVFLEET_RUNNER_IMAGE_DIGEST — runner image digest (e.g., "sha256:...")
...
Agent: ${DEVFLEET_AGENT_NAME} | Model: ${DEVFLEET_MODEL_ID} | Runner: ${DEVFLEET_RUNNER_IMAGE} (${DEVFLEET_RUNNER_IMAGE_DIGEST})
