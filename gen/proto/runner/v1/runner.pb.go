...
func (x *MCPProfile) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *MCPProfile) GetToolAllowlist() []string {
	if x != nil {
...
const file_proto_runner_v1_runner_proto_rawDesc = "" +
	...
	"\aheaders\x18\x05 \x03(\v2\".runner.v1.MCPProfile.HeadersEntryR\aheaders\x12%\n" +
	"\x0etool_allowlist\x18\x06 \x03(\tR\rtoolAllowlist\x1a:\n" +
