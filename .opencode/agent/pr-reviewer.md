...
### 6. PR Footer for Devfleet-Created PRs

When creating PRs as a devfleet agent, always append this footer to the PR description, resolving the environment variables `$DEVFLEET_AGENT_NAME`, `$DEVFLEET_MODEL_ID`, `$DEVFLEET_RUNNER_IMAGE`, and `$DEVFLEET_RUNNER_IMAGE_DIGEST`:
