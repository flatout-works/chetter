...
ALTER TABLE chetter_execution_attempts
    ADD COLUMN timeout_sec INT NOT NULL DEFAULT 600 AFTER lease_expires_at;

ALTER TABLE chetter_execution_attempts
    ADD COLUMN last_event_at DATETIME(6) NULL AFTER timeout_sec;

ALTER TABLE chetter_execution_attempts
    ADD COLUMN runner_image_digest VARCHAR(255) NULL AFTER harness_execution_id;
