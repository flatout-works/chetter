...
SET status = 'pending',
    ...
    checkpoint_after_success = sqlc.arg(checkpoint_after_success),
    claimed_at = NULL,
...
WHERE id = $4 AND runner_id = sqlc.arg(runner_id) AND execution_id = sqlc.arg(execution_id) AND status = 'running';
