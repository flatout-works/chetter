<script lang="ts">
  ...
  import { Button, Input, Label, Modal, PaginationNav, Search, Select, Spinner, Table, TableHead, TableHeadCell, TableBody, TableBodyRow, TableBodyCell, Textarea } from "flowbite-svelte";
...
<div class="p-6">
  ...
  <div class="flex flex-wrap items-center justify-between mb-6 gap-3">
    <Search
      ...
      class="!w-72"
      size="md"
      onkeydown={(e) => { if (e.key === "Enter") { page = 0; load(); } }}
    />
