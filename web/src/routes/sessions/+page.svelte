  ...
  <div class="flex flex-wrap items-center justify-between mb-6 gap-3">
    ...
    <div class="flex flex-wrap items-center gap-2">
      <div class="relative">
        ...
        <Input bind:value={search} placeholder="Search…" class="!w-36 !pl-10 !pr-8" onkeydown={(e) => { if (e.key === "Enter") { page = 0; load(); } }} />
        <button class="absolute inset-y-0 right-0 flex items-center pr-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300" onclick={() => { page = 0; load(); }} title="Search">
